...
Please note the name of this project's package has changed to zf-commons/zfc-acl
in order to match composer/packagist's new naming conventions. Please update your
composer.json to use the new package name.
...
# create this file in config/autoload/ZfcAcl.global.php
...
return array(
    'zfcacl' => array(
        ...
        'role_providers' => array(
             ...
             */
            'ZfcAcl\Provider\Role\Config' => array(
                'guest' => array(),
            ...
            'ZfcAcl\Provider\Role\ZendDb' => array(
                'table'             => 'user_role',
        ...
        'resource_providers' => array(
            'ZfcAcl\Provider\Resource\Config' => array(
                'pants' => array(),
            ),
        ),
        ...
        'rule_providers' => array(
            'ZfcAcl\Provider\Rule\Config' => array(
                'allow' => array(
